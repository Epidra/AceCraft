...
public class WorldGenOrangeTree extends WorldGenAbstractTree {
    ...
    public WorldGenOrangeTree(Block wood, Block leaves){
        this(wood, leaves, false, 4, 3, false);
    }
    
    public WorldGenOrangeTree(Block wood, Block leaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow){
        super(doBlockNotify);
        this.wood = wood;
        this.leaves = leaves;
