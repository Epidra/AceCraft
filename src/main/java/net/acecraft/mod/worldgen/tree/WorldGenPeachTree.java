...
public class WorldGenPeachTree extends WorldGenAbstractTree {
    ...
    public WorldGenPeachTree(Block wood, Block leaves){
        this(wood, leaves, false, 4, 3, false);
    }
    
    public WorldGenPeachTree(Block wood, Block leaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow){
        super(doBlockNotify);
        this.wood = wood;
        this.leaves = leaves;
