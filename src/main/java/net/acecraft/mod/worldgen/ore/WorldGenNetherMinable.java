package net.acecraft.mod.worldgen.ore;
...
public class WorldGenNetherMinable extends WorldGenerator {
    ...
    public WorldGenNetherMinable(Block block, int value){
        this(block, value, Blocks.netherrack);
    }
    
    public WorldGenNetherMinable(Block aBlock, int count, Block bBlock){
        this.blockA = aBlock;
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2){
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D){
                            for (int i3 = k1; i3 <= j2; ++i3){
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlock(k2, l2, i3).isReplaceableOreGen(world, k2, l2, i3, blockB)){
                                    world.setBlock(k2, l2, i3, this.blockA, mineableBlockMeta, 2);
                                }
                            }
                        }
                    }
