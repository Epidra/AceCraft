...
public class ModelCoconutBomb extends ModelBase
{
  //fields
  ...
  public ModelCoconutBomb()
  {
    textureWidth = 64;
    textureHeight = 32;
    
      Shape1 = new ModelRenderer(this, 2, 14);
