...
public class ModelZed extends ModelBase
{
    ...
    public ModelZed.ArmPose leftArmPose;
    public ModelZed.ArmPose rightArmPose;
    ...
    public ModelZed(float modelSize)
    {
        this(modelSize, 0.0F, 64, 32);
    }

    public ModelZed(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn)
    {
        this.leftArmPose = ModelZed.ArmPose.EMPTY;
        this.rightArmPose = ModelZed.ArmPose.EMPTY;
        this.textureWidth = textureWidthIn;
        this.textureHeight = textureHeightIn;
        this.bipedHead = new ModelRenderer(this, 0, 0);
        this.bipedHead.addBox(-4.0F, -8.0F, -4.0F, 6, 6, 6, modelSize);
        this.bipedHead.setRotationPoint(0.0F, 0.0F + p_i1149_2_, 0.0F);
        this.bipedHeadwear = new ModelRenderer(this, 32, 0);
        this.bipedHeadwear.addBox(-4.0F, -8.0F, -4.0F, 7, 7, 7, modelSize);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (this.rightArmPose == ModelZed.ArmPose.BOW_AND_ARROW)
        {
        ...
        else if (this.leftArmPose == ModelZed.ArmPose.BOW_AND_ARROW)
        {
    ...
    public void setModelAttributes(ModelBase model)
    {
        ...
        if (model instanceof ModelZed)
        {
            ModelZed modelbiped = (ModelZed)model;
