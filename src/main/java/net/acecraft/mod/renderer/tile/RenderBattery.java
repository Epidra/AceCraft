...
import net.acecraft.mod.model.ModelBattery;
...
public class RenderBattery extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(AceCraft.modid + ":" + "textures/model/Battery.png");
