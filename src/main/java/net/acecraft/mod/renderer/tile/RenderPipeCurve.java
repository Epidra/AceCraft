...
import net.acecraft.mod.model.ModelPipeCurve;
...
public class RenderPipeCurve extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation textureB = new ResourceLocation(AceCraft.modid + ":" + "textures/model/PipeCurveBronze.png");
	private static final ResourceLocation textureL = new ResourceLocation(AceCraft.modid + ":" + "textures/model/PipeCurveLead.png");
	
	private ModelPipeCurve model;
	
	private int rotation;
	private String texture;
	
	public RenderPipeCurve(String t){
		this.model = new ModelPipeCurve();
		texture = t;
		rotation = 0;
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        if (tileentity.getWorldObj() != null){
            ...
            TileEntityPipeCurve entity = (TileEntityPipeCurve)tileentity;
