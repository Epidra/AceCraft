...
import net.acecraft.mod.model.ModelMillstoneChild1;
import net.acecraft.mod.model.ModelMillstoneChild2;
import net.acecraft.mod.model.ModelMillstoneParent;
...
public class RenderMillstone extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        TileEntityMillstone entity = (TileEntityMillstone) tileentity;
        if(entity != null){
