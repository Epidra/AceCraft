...
public class StoveShapedRecipes implements IRecipe {
    ...
    public StoveShapedRecipes(int width, int height, ItemStack[] items, ItemStack output){
    ...
    public StoveShapedRecipes func_92100_c(){
