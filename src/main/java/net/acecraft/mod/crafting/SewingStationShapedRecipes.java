...
public class SewingStationShapedRecipes implements IRecipe {
    ...
    public SewingStationShapedRecipes(int width, int height, ItemStack[] items, ItemStack output){
    ...
    public SewingStationShapedRecipes func_92100_c(){
