...
public class RecipesShaped implements IRecipe{
    ...
    public RecipesShaped(int width, int height, ItemStack[] items, ItemStack output)    {
     ...
     */
    private boolean checkMatch(InventoryCrafting inventory, int intA, int intB, boolean p_77573_4_){
        for (int i = 0; i < 3; ++i){
            for (int j = 0; j < 3; ++j){
                int k = i - intA;
                int l = j - intB;
