...
public class AceCraftingManager {
	
	/** The static instance of this class */
    private static final AceCraftingManager INSTANCE = new AceCraftingManager();
    private final List<IRecipe> recipes = Lists.<IRecipe>newArrayList();

    /**
     * Returns the static instance of this class
     */
    public static AceCraftingManager getInstance(){
        /** The static instance of this class */
        return INSTANCE;
    }
    
    public AceCraftingManager(){
