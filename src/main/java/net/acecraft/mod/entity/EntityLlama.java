...
public class EntityLlama extends EntityAnimal implements net.minecraftforge.common.IShearable{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityLlama.class, DataSerializers.BYTE);
    ...
    protected SoundEvent getAmbientSound(){
    	return ShopKeeper.soundLlamaIdle;
    }
    
    protected SoundEvent getHurtSound(){
    	return ShopKeeper.soundLlamaHurt;
    }
    
    protected SoundEvent getDeathSound(){
    	return ShopKeeper.soundLlamaDeath;
    }
    ...
    public EntityLlama createChild(EntityAgeable ageable){
        ...
        EntityLlama entitychild = new EntityLlama(this.worldObj);
    ...
    private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother){
        ...
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityLlama)father).worldObj);
        int k;
