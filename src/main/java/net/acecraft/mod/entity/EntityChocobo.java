...
public class EntityChocobo extends EntityHorse implements net.minecraftforge.common.IShearable{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityChocobo.class, DataSerializers.BYTE);
    
    EnumFeatherColor featherColor = EnumFeatherColor.GREY;
    ...
    protected SoundEvent getAmbientSound(){
        return ShopKeeper.soundChocoboKweh;
    }
    ...
    public static EnumDyeColor getRandomSheepColor(Random random){
        ...
        if(i == 0) return EnumDyeColor.WHITE;
        if(i == 1) return EnumDyeColor.ORANGE;
        if(i == 2) return EnumDyeColor.MAGENTA;
        if(i == 3) return EnumDyeColor.LIGHT_BLUE;
        if(i == 4) return EnumDyeColor.YELLOW;
        if(i == 5) return EnumDyeColor.LIME;
        if(i == 6) return EnumDyeColor.PINK;
    ...
    public EntityChocobo createChild(EntityAgeable ageable){
        EntityChocobo entitycolor = (EntityChocobo)ageable;
        EntityChocobo entitychild = new EntityChocobo(this.worldObj);
    ...
    private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother){
        int i = ((EntityChocobo)father).getFleeceColor().getDyeDamage();
        int j = ((EntityChocobo)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityChocobo)father).worldObj);
        int k;
    ...
    public EnumFeatherColor getFeatherColor(){
    	switch((Byte)this.dataManager.get(DYE_COLOR).byteValue()){
    	case  0: return EnumFeatherColor.GREY;
    	case  1: return EnumFeatherColor.RED;
    	case  2: return EnumFeatherColor.GREEN;
    	case  3: return EnumFeatherColor.BLUE;
    	case  4: return EnumFeatherColor.ORANGE;
    	case  5: return EnumFeatherColor.VIOLET;
    	case  6: return EnumFeatherColor.YELLOW;
    	case  7: return EnumFeatherColor.GREY;
    	case  8: return EnumFeatherColor.RED;
    	case  9: return EnumFeatherColor.GREEN;
    	case 10: return EnumFeatherColor.BLUE;
    	case 11: return EnumFeatherColor.ORANGE;
    	case 12: return EnumFeatherColor.VIOLET;
    	case 13: return EnumFeatherColor.YELLOW;
    }
    	return featherColor;
    }
    
    public enum EnumFeatherColor {
    	GREY, RED, GREEN, BLUE, ORANGE, VIOLET, YELLOW
    }
