...
public class MachinaDestille extends IMachinaFlamer{

    public MachinaDestille(String name){
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ){
        if (worldIn.isRemote){
            ...
            if (tileentity instanceof TileEntityDistillery){
            	playerIn.openGui(AceCraft.instance, ShopKeeper.guiIDDistillery, worldIn, pos.getX(), pos.getY(), pos.getZ());
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state){
        return new ItemStack(ShopKeeper.machinaDestille);
    }
}