    ...
    public void detectAndSendChanges(){
        ...
        for (int i = 0; i < this.listeners.size(); ++i){
            ...
            if (this.cookTime != this.tileBonfire.getField(2)){
                icontainerlistener.sendProgressBarUpdate(this, 2, this.tileBonfire.getField(2));
            }
            if (this.furnaceBurnTime != this.tileBonfire.getField(0)){
                icontainerlistener.sendProgressBarUpdate(this, 0, this.tileBonfire.getField(0));
            }
            if (this.currentItemBurnTime != this.tileBonfire.getField(1)){
                icontainerlistener.sendProgressBarUpdate(this, 1, this.tileBonfire.getField(1));
            }
            if (this.totalCookTime != this.tileBonfire.getField(3)){
                icontainerlistener.sendProgressBarUpdate(this, 3, this.tileBonfire.getField(3));
            }
        }
