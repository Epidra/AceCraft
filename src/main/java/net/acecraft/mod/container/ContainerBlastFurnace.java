    ...
    public void detectAndSendChanges(){
        ...
        for (int i = 0; i < this.listeners.size(); ++i){
            ...
            if (this.cookTime != this.tileBlastFurnace.getField(2)){
                icontainerlistener.sendProgressBarUpdate(this, 2, this.tileBlastFurnace.getField(2));
            }
            if (this.furnaceBurnTime != this.tileBlastFurnace.getField(0)){
                icontainerlistener.sendProgressBarUpdate(this, 0, this.tileBlastFurnace.getField(0));
            }
            if (this.currentItemBurnTime != this.tileBlastFurnace.getField(1)){
                icontainerlistener.sendProgressBarUpdate(this, 1, this.tileBlastFurnace.getField(1));
            }
            if (this.totalCookTime != this.tileBlastFurnace.getField(3)){
                icontainerlistener.sendProgressBarUpdate(this, 3, this.tileBlastFurnace.getField(3));
            }
        }
