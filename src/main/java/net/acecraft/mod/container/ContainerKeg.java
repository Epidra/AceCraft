    ...
    public void detectAndSendChanges(){
        ...
        for (int i = 0; i < this.listeners.size(); ++i){
            ...
            if (this.lastContent != this.tileKeg.content){
                icrafting.sendProgressBarUpdate(this, 0, transmuteContent(this.tileKeg.content));
            }
            if (this.lastFillingLevel != this.tileKeg.fillingLevel){
                icrafting.sendProgressBarUpdate(this, 1, this.tileKeg.fillingLevel);
            }
            if (this.lastFermentCurrent != this.tileKeg.fermentCurrent){
                icrafting.sendProgressBarUpdate(this, 2, this.tileKeg.fermentCurrent);
            }
        }
