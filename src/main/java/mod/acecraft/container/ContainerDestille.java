...
public class ContainerDestille extends ContainerBase {

    public static final ContainerType<ContainerDestille> TYPE = (ContainerType<ContainerDestille>) IForgeContainerType.create(ContainerDestille::new).setRegistryName(AceCraft.MODID, "destille");
    ...
    public ContainerDestille(ContainerType<?> type, int windowID, PlayerInventory playerInventory, PacketBuffer packetBuffer) {
    ...
    public ContainerDestille(ContainerType<?> type, int windowID, PlayerInventory playerInventory, BlockPos pos) {
        this(type, windowID, playerInventory, (TileEntityBase) playerInventory.player.getEntityWorld().getTileEntity(pos));
        this.pos = pos;
    }

    public ContainerDestille(ContainerType<?> type, int windowID, PlayerInventory playerInventory, TileEntityBase board) {
        super(type, windowID);
    ...
    public ContainerDestille(int windowID, PlayerInventory playerInventory, TileEntityBase board) {
        this(TYPE, windowID, playerInventory, board);
    }

    public ContainerDestille(int windowID, PlayerInventory playerInventory, PacketBuffer packetBuffer) { // Forge Registry
    ...
    public boolean canInteractWith(@Nonnull PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tile.getWorld(), tile.getPos()), playerIn, ShopKeeper.MACHINA_DESTILLERY);
    }
