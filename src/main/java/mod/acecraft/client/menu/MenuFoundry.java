...
public class MenuFoundry extends MenuBase {
	...
	public MenuFoundry(int containerID, Inventory playerInventory, FriendlyByteBuf buffer){
		this(containerID, playerInventory, buffer.readBlockPos());
	}
	
	// Server Menu Constructor
	public MenuFoundry(int containerID, Inventory playerInventory, BlockPos pos){
		super(Register.MENU_FOUNDRY.get(), containerID, playerInventory, pos);
	}
	...
	protected void createInventory(Container container, Inventory player){
		this.addSlot(new Slot(container, 0, 62, 11)); // INPUT
		this.addSlot(new Slot(container, 1, 75, 57)); // OUTPUT 1
		this.addSlot(new Slot(container, 2, 91, 57)); // OUTPUT 2
		this.addSlot(new Slot(container, 3, 107, 57)); // OUTPUT 3
		this.addSlot(new Slot(container, 4, 123, 57)); // OUTPUT 4
		this.addSlot(new Slot(container, 5, 139, 57)); // OUTPUT 5
