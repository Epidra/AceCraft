...
@OnlyIn(Dist.CLIENT)
public class GuiStove extends ContainerScreen<WorkbenchContainer> implements IRecipeShownListener {
    ...
    public GuiStove(WorkbenchContainer p_i51094_1_, PlayerInventory p_i51094_2_, ITextComponent p_i51094_3_) {
