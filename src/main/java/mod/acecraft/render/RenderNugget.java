...
@OnlyIn(Dist.CLIENT)
public class RenderNugget <T extends Entity & IRendersAsItem> extends EntityRenderer<T> {

    private final net.minecraft.client.renderer.ItemRenderer itemRenderer;
    private final float scale;

    public RenderNugget(EntityRendererManager p_i50956_1_, net.minecraft.client.renderer.ItemRenderer p_i50956_2_, float p_i50956_3_) {
        super(p_i50956_1_);
        this.itemRenderer = p_i50956_2_;
        this.scale = p_i50956_3_;
    }

    public RenderNugget(EntityRendererManager p_i50957_1_, net.minecraft.client.renderer.ItemRenderer p_i50957_2_) {
