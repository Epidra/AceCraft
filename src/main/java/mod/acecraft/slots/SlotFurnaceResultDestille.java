...
public class SlotFurnaceResultDestille extends Slot {

    private final PlayerEntity player;
    private int removeCount;

    public SlotFurnaceResultDestille(PlayerEntity player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
