...
public class SlotFuel extends Slot {
    ...
    private final ContainerBase field_216939_a;

    public SlotFuel(ContainerBase p_i50084_1_, IInventory p_i50084_2_, int p_i50084_3_, int p_i50084_4_, int p_i50084_5_) {
