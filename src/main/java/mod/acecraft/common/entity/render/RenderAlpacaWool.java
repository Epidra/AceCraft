...
@OnlyIn(Dist.CLIENT)
public class RenderAlpacaWool extends RenderLayer<EntityAlpaca, ModelAlpaca<EntityAlpaca>> {
	...
	public RenderAlpacaWool(RenderLayerParent<EntityAlpaca, ModelAlpaca<EntityAlpaca>> renderer, EntityModelSet modelSet) {
		super(renderer);
		this.model = new ModelAlpacaWool<>(modelSet.bakeLayer(ModelLayers.SHEEP_FUR));
	}
