...
public class ScreenFoundry extends ContainerScreen<ContainerFoundry> {

    private static final ResourceLocation background = new ResourceLocation(MODID, "textures/gui/foundry.png");

    private ContainerFoundry container;

    public ScreenFoundry(ContainerFoundry container, PlayerInventory playerInventory, ITextComponent title) {
