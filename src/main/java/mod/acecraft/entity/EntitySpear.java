...
public class EntitySpear extends Entity implements IProjectile {
    ...
    public EntitySpear(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntitySpear.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
    ...
    public EntitySpear(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntitySpear.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntitySpear.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntitySpear.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntitySpear.PickupStatus.ALLOWED : EntitySpear.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntitySpear.PickupStatus.ALLOWED || this.pickupStatus == EntitySpear.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;
