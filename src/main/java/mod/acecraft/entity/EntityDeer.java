...
public class EntityDeer extends AnimalEntity {
    ...
    public EntityDeer(EntityType<? extends EntityDeer> entity, World world) {
        super(entity, world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EntityDeer.EntityAIExtinguishFire());
