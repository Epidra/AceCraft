...
public class EntityLlama extends AnimalEntity {
    ...
    public EntityLlama(EntityType<? extends EntityLlama> entity, World world) {
        super(entity, world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EntityLlama.EntityAIExtinguishFire());
    ...
    private class EntityAIExtinguishFire extends PanicGoal {
        EntityAIExtinguishFire() {
            super(EntityLlama.this, 2.0D);
        }

        @Override
        public boolean shouldExecute() {
            return (EntityLlama.this.isChild() || EntityLlama.this.isBurning()) && super.shouldExecute();
        }
    }
