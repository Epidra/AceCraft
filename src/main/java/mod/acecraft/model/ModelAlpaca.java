...
@OnlyIn(Dist.CLIENT)
public class ModelAlpaca<T extends EntityAlpaca>  extends AgeableModel<T> {
    ...
    public ModelAlpaca() {
        ...
        Body.texOffs(0, 0).addBox(-5.0F, -19.0F, -8.0F, 10.0F, 8.0F, 16.0F, 0.0F, false);

        LegBackRight = new ModelRenderer(this);
        LegBackRight.setPos(-2.5F, 12.0F, 5.5F);
        LegBackRight.texOffs(36, 0).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, 0.0F, false);

        LegBackLeft = new ModelRenderer(this);
        LegBackLeft.setPos(2.5F, 12.0F, 5.5F);
        LegBackLeft.texOffs(0, 38).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, 0.0F, false);

        LegFrontRight = new ModelRenderer(this);
        LegFrontRight.setPos(-2.5F, 12.0F, -5.5F);
        LegFrontRight.texOffs(36, 24).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, 0.0F, false);

        LegFrontLeft = new ModelRenderer(this);
        LegFrontLeft.setPos(2.5F, 12.0F, -5.5F);
        LegFrontLeft.texOffs(24, 24).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, 0.0F, false);

        Head = new ModelRenderer(this);
        Head.setPos(0.0F, 7.0F, -7.0F);
        Head.texOffs(26, 39).addBox(-3.5F, -21.0F, -2.0F, 3.0F, 4.0F, 2.0F, 0.0F, false);
        Head.texOffs(36, 39).addBox(0.5F, -21.0F, -2.0F, 3.0F, 4.0F, 2.0F, 0.0F, false);
        Head.texOffs(0, 24).addBox(-3.0F, -18.0F, -5.0F, 6.0F, 8.0F, 6.0F, 0.0F, false);
        Head.texOffs(0, 0).addBox(-2.0F, -10.0F, -4.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
        Head.texOffs(12, 38).addBox(-2.0F, -14.0F, -8.0F, 4.0F, 4.0F, 3.0F, 0.0F, false);
    }
