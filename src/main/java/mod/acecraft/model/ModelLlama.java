...
public class ModelLlama <T extends Entity> extends EntityModel<T> {
    ...
    //fields
    RendererModel BodyClean;
    RendererModel BodyFur;
    RendererModel LegFrontLeftClean;
    RendererModel LegFrontLeftFur;
    RendererModel LegFrontRightClean;
    RendererModel LegFrontRightFur;
    RendererModel LegBackLeftClean;
    RendererModel LegBackLeftFur;
    RendererModel LegBackRightClean;
    RendererModel LegBackRightFur;
    RendererModel NeckClean;
    RendererModel NeckFur;
    RendererModel Head;
    RendererModel Nose;
    ...
    public ModelLlama()
    {
        ...
        BodyClean = new RendererModel(this, 1, 1);
        ...
        BodyFur = new RendererModel(this, 62, 0);
        ...
        LegFrontLeftClean = new RendererModel(this, 2, 35);
        ...
        LegFrontLeftFur = new RendererModel(this, 0, 49);
        ...
        LegFrontRightClean = new RendererModel(this, 19, 35);
        ...
        LegFrontRightFur = new RendererModel(this, 17, 49);
        ...
        LegBackLeftClean = new RendererModel(this, 36, 35);
        ...
        LegBackLeftFur = new RendererModel(this, 34, 49);
        ...
        LegBackRightClean = new RendererModel(this, 53, 35);
        ...
        LegBackRightFur = new RendererModel(this, 51, 49);
        ...
        NeckClean = new RendererModel(this, 43, 1);
        ...
        NeckFur = new RendererModel(this, 56, 0);
        ...
        EarRight = new RendererModel(this, 77, 34);
        ...
        Tail = new RendererModel(this, 3, 3);
