...
public class ModelGoat <T extends Entity> extends EntityModel<T> {
    ...
    public ModelGoat()
    {
        ...
        LegFrontLeft = new RendererModel(this, 32, 0);
        ...
        LegFrontRight = new RendererModel(this, 40, 0);
        ...
        LegBackLeft = new RendererModel(this, 48, 0);
        ...
        LegBackRight = new RendererModel(this, 56, 0);
        ...
        EarRight = new RendererModel(this, 33, 26);
        ...
        HornLeft = new RendererModel(this, 49, 22);
        ...
        HornRight = new RendererModel(this, 44, 22);
        ...
        Tail = new RendererModel(this, 44, 27);
