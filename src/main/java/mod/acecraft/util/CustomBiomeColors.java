...
public class CustomBiomeColors {
    ...
    private static final CustomBiomeColors.IColorResolver GRASS_COLOR = Biome::getGrassColor;
    private static final CustomBiomeColors.IColorResolver FOLIAGE_COLOR = Biome::getFoliageColor;
    private static final CustomBiomeColors.IColorResolver WATER_COLOR = (p_210280_0_, p_210280_1_) -> {
        return p_210280_0_.getWaterColor();
    };
    private static final CustomBiomeColors.IColorResolver WATER_FOG_COLOR = (p_210279_0_, p_210279_1_) -> {
        return p_210279_0_.getWaterFogColor();
    };

    private static int getColor(IEnviromentBlockReader reader, BlockPos pos, CustomBiomeColors.IColorResolver resolver) {
        int i = 0;
        int j = 0;
        int k = 0;
