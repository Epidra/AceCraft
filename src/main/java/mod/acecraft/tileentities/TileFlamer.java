...
import mod.acecraft.blocks.BlockFlamer;
...
public abstract class TileFlamer extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0: return TileFlamer.this.burnTime;
                case 1: return TileFlamer.this.recipesUsed;
                case 2: return TileFlamer.this.cookTime;
                case 3: return TileFlamer.this.cookTimeTotal;
                default: return 0;
            }
        }
        public void set(int index, int value) {
            switch(index) {
                case 0: TileFlamer.this.burnTime = value; break;
                case 1: TileFlamer.this.recipesUsed = value; break;
                case 2: TileFlamer.this.cookTime = value; break;
                case 3: TileFlamer.this.cookTimeTotal = value;
            }
        }
        public int size() {
            return 4;
    ...
    protected TileFlamer(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn) {
        super(tileTypeIn);
        this.recipeType = recipeTypeIn;
    }

    public TileFlamer(TileEntityType<TileEntity> tileTypeIn) {
        super(tileTypeIn);
        recipeType = null;
    }
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(BlockFlamer.LIT, Boolean.valueOf(this.isBurning())), 3);
            }
        }
