...
import mod.acecraft.blocks.BlockDistillery;
...
public abstract class TileDistilleryAbstract extends TileBase implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray data = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return TileDistilleryAbstract.this.burnTime;
                case 1:
                    return TileDistilleryAbstract.this.recipesUsed;
                case 2:
                    return TileDistilleryAbstract.this.cookTime;
                case 3:
                    return TileDistilleryAbstract.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    TileDistilleryAbstract.this.burnTime = value;
                    break;
                case 1:
                    TileDistilleryAbstract.this.recipesUsed = value;
                    break;
                case 2:
                    TileDistilleryAbstract.this.cookTime = value;
                    break;
                case 3:
                    TileDistilleryAbstract.this.cookTimeTotal = value;
            }
    ...
    protected final IRecipeType<? extends RecipeDistillery> recipeType;

    protected TileDistilleryAbstract(TileEntityType<?> tileTypeIn, IRecipeType<? extends RecipeDistillery> recipeTypeIn) {
        super(tileTypeIn);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.items.get(0).isEmpty() && !this.items.get(1).isEmpty()) {
                Optional<RecipeDistillery> optional = this.world.getRecipeManager().getRecipe(RecipeDistillery.destille, this, this.world);
                if (optional.isPresent()) {
                    RecipeDistillery icraftingrecipe = optional.get();
                ...
                IRecipe<?> irecipe = this.world.getRecipeManager().getRecipe((IRecipeType<RecipeDistillery>)this.recipeType, this, this.world).orElse(null);
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(BlockDistillery.LIT, Boolean.valueOf(this.isBurning())), 3);
            }
        }
    ...
    protected int func_214005_h() {
        return this.world.getRecipeManager().getRecipe((IRecipeType<RecipeDistillery>)this.recipeType, this, this.world).map(RecipeDistillery::getCookTime).orElse(200);
    }
    ...
    public void func_213995_d(PlayerEntity p_213995_1_) {
        ...
        for(Map.Entry<ResourceLocation, Integer> entry : this.field_214022_n.entrySet()) {
            p_213995_1_.world.getRecipeManager().getRecipe(entry.getKey()).ifPresent((p_213993_3_) -> {
                ...
                func_214003_a(p_213995_1_, entry.getValue(), ((RecipeDistillery)p_213993_3_).getExperience());
            });
        }
