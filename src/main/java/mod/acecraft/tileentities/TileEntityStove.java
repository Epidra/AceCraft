...
public class TileEntityStove extends TileEntityBase {
    ...
    public static TileEntityType<TileEntity> TYPE = (TileEntityType<TileEntity>) TileEntityType.Builder.create((Supplier<TileEntity>) TileEntityStove::new, ShopKeeper.MACHINA_STOVE).build(null).setRegistryName(MODID, "stove");
