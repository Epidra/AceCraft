...
public class TileDistillery extends TileDistilleryAbstract {
    ...
    public TileDistillery() {
        ...
        super(ShopKeeper.TILE_DISTILLERY.get(), RecipeDistillery.destille);
    ...
    public SUpdateTileEntityPacket getUpdatePacket(){
        ...
        return new SUpdateTileEntityPacket(this.pos, ShopKeeper.TILE_DISTILLERY.get().hashCode(), nbtTagCompound);
    }
    ...
    private IItemHandlerModifiable createNonSidedInventoryHandler(@Nonnull NonNullList<ItemStack> stacks) {
        ...
        return new ItemStackHandler(stacks) {
            ...
            public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
                ...
                if (TileDistillery.this.isItemValid(stack)) {
    ...
    private IItemHandlerModifiable createSidedInventoryHandler(@Nonnull NonNullList<ItemStack> stacks) {
        ...
        return new ItemStackHandler(stacks) {
            ...
            public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
                ...
                if (slot == 0 && TileDistillery.this.isItemValid(stack)) {
...
//
    ...
    private Optional<RecipeDistillery> getRecipe(@Nonnull ItemStack item) {

        assert world != null;

        tmpItemHandler.setStackInSlot(0, item);

        return world.getRecipeManager().getRecipe(RecipeDistillery.destille, tmpItemHandlerWrapper, world);
