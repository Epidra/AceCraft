...
import mod.acecraft.blocks.MachinaDestille;
...
public abstract class TileEntityDestilleAbstract extends TileEntityBase implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray data = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return TileEntityDestilleAbstract.this.burnTime;
                case 1:
                    return TileEntityDestilleAbstract.this.recipesUsed;
                case 2:
                    return TileEntityDestilleAbstract.this.cookTime;
                case 3:
                    return TileEntityDestilleAbstract.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    TileEntityDestilleAbstract.this.burnTime = value;
                    break;
                case 1:
                    TileEntityDestilleAbstract.this.recipesUsed = value;
                    break;
                case 2:
                    TileEntityDestilleAbstract.this.cookTime = value;
                    break;
                case 3:
                    TileEntityDestilleAbstract.this.cookTimeTotal = value;
            }
    ...
    protected final IRecipeType<? extends RecipeDestille> recipeType;

    protected TileEntityDestilleAbstract(TileEntityType<?> tileTypeIn, IRecipeType<? extends RecipeDestille> recipeTypeIn) {
        super(tileTypeIn);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.items.get(0).isEmpty() && !this.items.get(1).isEmpty()) {
                Optional<RecipeDestille> optional = this.world.getRecipeManager().getRecipe(RecipeDestille.destille, this, this.world);
                if (optional.isPresent()) {
                    RecipeDestille icraftingrecipe = optional.get();
                ...
                IRecipe<?> irecipe = this.world.getRecipeManager().getRecipe((IRecipeType<RecipeDestille>)this.recipeType, this, this.world).orElse(null);
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(MachinaDestille.LIT, Boolean.valueOf(this.isBurning())), 3);
            }
        }
    ...
    protected int func_214005_h() {
        return this.world.getRecipeManager().getRecipe((IRecipeType<RecipeDestille>)this.recipeType, this, this.world).map(RecipeDestille::getCookTime).orElse(200);
    }
    ...
    public void func_213995_d(PlayerEntity p_213995_1_) {
        ...
        for(Map.Entry<ResourceLocation, Integer> entry : this.field_214022_n.entrySet()) {
            p_213995_1_.world.getRecipeManager().getRecipe(entry.getKey()).ifPresent((p_213993_3_) -> {
                ...
                func_214003_a(p_213995_1_, entry.getValue(), ((RecipeDestille)p_213993_3_).getExperience());
            });
        }
