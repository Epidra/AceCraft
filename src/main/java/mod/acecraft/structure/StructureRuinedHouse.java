package mod.acecraft.structure;

public class StructureRuinedHouse /* extends StructureFeature<JigsawConfiguration> */ {

//    public StructureRuinedHouse(Codec<JigsawConfiguration> codec) {
//        // Create the pieces layout of the structure and give it to the game
//        super(codec, StructureRuinedHouse::createPiecesGenerator, PostPlacementProcessor.NONE);
//    }
//
//    /**
...
//        if(event.getStructure() == ShopKeeper.STRUCTURE_RUINED_HOUSE.get()) {
...
//        if (!StructureRuinedHouse.isFeatureChunk(context)) {
...
//                        .get(new ResourceLocation(AceCraft.MODID, "ruined_house/start_pool")),
//
