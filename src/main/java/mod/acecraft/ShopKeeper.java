...
public class ShopKeeper {
    ...
    static void registerRenderer() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ENTITY_DYNAMITE, RenderDynamite::new);
        RenderingRegistry.registerEntityRenderingHandler(ENTITY_SPEAR, RenderSpear::new);
        RenderingRegistry.registerEntityRenderingHandler(ENTITY_NUGGET, RenderNugget::new);
    }
