...
public class CampfireRecipes {
    ...
    private CampfireRecipes(){
        ...
        this.addSmelting(ShopKeeper.FOOD_VENISON_RAW, new ItemStack(ShopKeeper.FOOD_VENISON_COOKED), 0.35F);
        this.addSmelting(ShopKeeper.FOOD_VICUGNA_RAW, new ItemStack(ShopKeeper.FOOD_VICUGNA_COOKED), 0.35F);
