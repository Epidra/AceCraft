...
public class RecipeDistillery implements IRecipe<IInventory> {

    public static final IRecipeType<RecipeDistillery> destille = IRecipeType.register("destille");
    ...
    public RecipeDistillery(ResourceLocation resourceLocation, String group, NonNullList<Ingredient> ingredients, ItemStack result, float experienceIn, int cookTimeIn) {
        type = destille;
        id = resourceLocation;
        this.group = group;
    ...
    public RecipeDistillery(ResourceLocation resourceLocation, String group, Ingredient ingredient, ItemStack itemStack) {
        type = destille;
        id = resourceLocation;
        this.group = group;
        this.recipeItems = NonNullList.withSize(2, Ingredient.EMPTY);
    ...
    public IRecipeSerializer<?> getSerializer() {
        ...
        return ShopKeeper.serializerDistillery;
    }
    ...
    public ItemStack getIcon() {
        return new ItemStack(ShopKeeper.MACHINA_DISTILLERY.get());
    }
