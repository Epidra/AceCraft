...
public class RecipeDestilleSerializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<RecipeDestille> {

    private final int cookingTime;

    private final RecipeDestilleSerializer.IFactory<RecipeDestille> factory;

    public RecipeDestilleSerializer(RecipeDestilleSerializer.IFactory<RecipeDestille> factory) {
        this.factory = factory;
        this.cookingTime = 200;
    }

    public RecipeDestille read(ResourceLocation recipeId, JsonObject json) {
    ...
    public RecipeDestille read(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        return new RecipeDestille(recipeId, s, nonnulllist, itemstack, f, c);
    }
...
//
    ...
    public interface IFactory<T extends RecipeDestille> {
