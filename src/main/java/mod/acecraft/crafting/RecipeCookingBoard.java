...
public class RecipeCookingBoard implements IRecipe<IInventory> {

    public static final IRecipeType<RecipeCookingBoard> stove = IRecipeType.register("stove");
    ...
    public RecipeCookingBoard(ResourceLocation resourceLocation, String group, NonNullList<Ingredient> ingredients, ItemStack result) {
        type = stove;
        id = resourceLocation;
        this.group = group;
    ...
    public RecipeCookingBoard(ResourceLocation resourceLocation, String group, Ingredient ingredient, ItemStack itemStack) {
        type = stove;
        id = resourceLocation;
        this.group = group;
    ...
    public IRecipeSerializer<?> getSerializer() {
        ...
        return ShopKeeper.serializerCookingBoard;
    }
    ...
    public ItemStack getIcon() {
        return new ItemStack(ShopKeeper.MACHINA_COOKINGBOARD.get());
    }
