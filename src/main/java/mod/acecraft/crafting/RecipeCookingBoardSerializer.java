...
public class RecipeCookingBoardSerializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<RecipeCookingBoard> {

    private final RecipeCookingBoardSerializer.IFactory<RecipeCookingBoard> factory;

    public RecipeCookingBoardSerializer(RecipeCookingBoardSerializer.IFactory<RecipeCookingBoard> factory) {
        this.factory = factory;
    }

    public RecipeCookingBoard read(ResourceLocation recipeId, JsonObject json) {
        ...
        if (nonnulllist.isEmpty()) {
            ...
            ItemStack itemstack = RecipeCookingBoard.deserializeItem(JSONUtils.getJsonObject(json, "result"));
            return new RecipeCookingBoard(recipeId, s, nonnulllist, itemstack);
        }
    }
    ...
    public RecipeCookingBoard read(ResourceLocation recipeId, PacketBuffer buffer) {
    ...
    public void write(PacketBuffer buffer, RecipeCookingBoard recipe) {
...
//
    ...
    public interface IFactory<T extends RecipeCookingBoard> {
